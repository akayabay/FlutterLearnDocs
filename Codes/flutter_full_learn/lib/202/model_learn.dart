...
class PostModel6 {
  // late : Bu değer sonradan gelecek.
  // late final: Bu değer sadece constructor anında sonradan gelebilir
...
// Servisten bir değer gelmesi durumunda best practice
class PostModel8 {
  final int? userId;
  final int? id;
  final String? title;
  ...
  // Model yazarken bir instance özelinde değer update etme gibi durumlarda 
  // kesinlikle özel durumlar haricinde !(force) kullanılmayacak
  // ek olarak null ve isnotempty kontrolü yapılacak
  ...
  // Önceki nesnenin bir kopyasını oluşturur
  // Yeni verilen parametrelerin yeni değerleri oluşturulan yeni nesneye atanır
  // Verilmeyen parametreler eski değerlerini alır
  PostModel8 copyWith({
    int? userId,
    int? id,
    String? title,
